...
public class StrTransactionExecutor extends BaseTransactionExecutor<String, Object> {

    public StrTransactionExecutor(RocketMQTransactionTemplate rocketMQTransactionTemplate) {
