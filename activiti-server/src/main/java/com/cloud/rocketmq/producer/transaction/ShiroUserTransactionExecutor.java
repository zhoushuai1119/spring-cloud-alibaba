...
public class ShiroUserTransactionExecutor extends BaseTransactionExecutor<ShiroUser, Object> {
    ...
    @Override
    public LocalTransactionState executeTransaction(MonsterMessage<ShiroUser> message, Object arg) {
        log.info("事务消息执行本地事务*********");
    ...
    @Override
    public LocalTransactionState checkLocalTransaction(MonsterMessage<ShiroUser> message) {
