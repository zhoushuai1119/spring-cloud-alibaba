 ...
 */
@Slf4j
@ConsumeTopic(topic = "TP_F_SC", eventCode = "EC_TASK_ACTIVITI_JOB_TEST", log = true)
public class ActivitiTimeTaskTestListener implements TopicListener<String> {

    @Override
    public void onMessage(CloudMessage<String> message) {
        log.info("activiti server time task mq test");
    }
