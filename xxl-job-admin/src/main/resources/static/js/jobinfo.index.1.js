    ...
    var jobTable = $("#job_list").dataTable({
        ...
        "ajax": {
            ...
            data: function (d) {
                ...
                obj.systemCode = $('#systemCode').val();
                obj.executorParam = $('#executorParam').val();
                ...
                "render": function (data, type, row) {
                    return function () {
                        ...
                        var html = '<div class="btn-group">\n' +
                            ...
                            '       <li><a href="javascript:void(0);" class="job_operate" _type="job_execute_once" >' + I18n.jobinfo_opt_run + '</a></li>\n' +
