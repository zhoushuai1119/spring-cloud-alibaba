...
public class UserTransactionExecutor extends BaseTransactionExecutor<User, Object> {
    ...
    @Override
    public LocalTransactionState executeTransaction(MonsterMessage<User> message, Object arg) {
        log.info("事务消息执行本地事务*********");
    ...
    @Override
    public LocalTransactionState checkLocalTransaction(MonsterMessage<User> message) {
