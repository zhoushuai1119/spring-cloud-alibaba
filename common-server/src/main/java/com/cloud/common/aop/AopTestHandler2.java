...
public class AopTestHandler2 {
    ...
    public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info("AopTestHandler2 : doAround-1");
        Object result = joinPoint.proceed();
        log.info("AopTestHandler2 : doAround-2");
        log.info("AopTestHandler2 result:{}",result);
        return result;
    }

    @Before("loggerHandler()")
    public void before(JoinPoint point) {
        log.info("AopTestHandler2 : doBefore");
    }

    @After("loggerHandler()")
    public void after() {
        log.info("AopTestHandler2 : doAfter");
    }


    @AfterThrowing(pointcut = "loggerHandler()", throwing = "e")
    public void afterThrowing(Exception e) {
        log.info("AopTestHandler2 : doAfterThrowing");
    }
    ...
    public void afterReturning(JoinPoint point,Object returnValue) throws Throwable {
        log.info("AopTestHandler2 : doAfterReturning");
    }
