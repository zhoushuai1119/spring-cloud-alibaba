 ...
 */
@Slf4j
@TansactionTopic(topic = CommonConstant.topic.PRODUCT_SERVER_TOPIC_TRANSACTION, eventCode = "EC_PRODUCT_SERVER_TRANSACTION")
public class ProductTransactionExecutor extends BaseTransactionExecutor<Product, Object> {
    ...
    @Override
    public LocalTransactionState executeTransaction(MonsterMessage<Product> message, Object arg) {
        log.info("事务消息执行本地事务*********");
    ...
    @Override
    public LocalTransactionState checkLocalTransaction(MonsterMessage<Product> message) {
