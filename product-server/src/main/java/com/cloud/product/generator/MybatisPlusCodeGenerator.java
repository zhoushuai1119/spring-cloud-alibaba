package com.cloud.product.generator;
...
public class MybatisPlusCodeGenerator {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://139.196.208.53:3306/product_master1?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf-8&useSSL=false", "root", "Zs11195310")
            .dbQuery(new MySqlQuery())
            .schema("");

    // 多个用,  拼接
    public static final String TABLE_NAMES = "t_dict";
    //包名路径
    public static final String PACKAGE_PATH = "com.cloud.product";
    //服务名
    public static final String APPLICATION_NAME = "product-server";
